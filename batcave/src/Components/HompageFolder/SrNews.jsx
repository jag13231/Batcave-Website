      ...
      <section className='blog'>
        ...
        <div className="blog-container1">
            ...
            <div className="txt-box">
                ...
                <ul>
                    <li><RxCalendar  className='icon'/>02 July , 2025</li>
                    <li> <RxClock  className='icon'/>10.00 PM</li>
                    <li><GoLocation className='icon'/> ECR</li>
                </ul>
         ...
         <div className="blog-container2">
            <div className="txt-box2">
                <h3>The Ultimate Car Club Experience</h3>
                 <ul>
                    <li><RxClock  className='icon'/>02 July , 2025</li>
                    <li> <RxClock  className='icon'/>10.00 PM</li>
                    <li><GoLocation  className='icon'/>ECR</li>
                </ul>
